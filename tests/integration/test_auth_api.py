...
from backend.app.infrastructure.security.auth import verify_password
import re
...
class TestAuthAPI:
    ...
    async def test_expired_token(self, client):
        ...
        client.headers.update({"Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0QGV4YW1wbGUuY29tIiwiZXhwIjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"})
        response = await client.get("/users/me")
